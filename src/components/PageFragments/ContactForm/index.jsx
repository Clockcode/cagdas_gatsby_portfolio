...
export default () => {
  ...
  return (
    <Col sm={24} md={24} lg={12} className="widthFull">
      <Form form={form} method="POST" action="https://getform.io/f/b0743d7b-944d-4f9f-8826-10c1877a54e3" name="contact" onFinish={onFinish} validateMessages={validateMessages}>
